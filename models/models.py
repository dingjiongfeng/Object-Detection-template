...
class VGGBase(nn.Module):
    ...
    def load_pretrained_layers(self):
        ...
        # print(param_names)
        pretrain_state_dict = torchvision.models.vgg16(pretrained=True).state_dict()
...
class PredictionConvolutions(nn.Module):
    ...
    def __init__(self, n_classes):
        ...
        self.num_box = 9
        self.loc_conv = nn.Conv2d(512, self.num_box * 4, kernel_size=3, stride=1, padding=1)
        self.clf_conv = nn.Conv2d(512, self.num_box * n_classes, kernel_size=3, stride=1, padding=1)
...
class tiny_detector(nn.Module):
    ...
    def create_prior_boxes(self):
        ...
        prior_boxes = prior_boxes.clamp(0, 1)
...
class MultiBoxLoss(nn.Module):
    ...
    def forward(self, predicted_locs, predicted_scores, boxes, labels):
        ...
        for i in range(batch_size):
            ...
            true_locs[i] = cxcy_to_gcxgcy(xy2cxcy(boxes[i][object_for_each_prior]), self.priors_cxcy)  # (441, 4) true_locs有nan
